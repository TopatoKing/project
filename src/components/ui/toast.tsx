...
// Defines the toast provider.
const ToastProvider = ToastPrimitives.Provider;

// Defines the toast viewport.
...
// Sets the display name for the toast component.
Toast.displayName = ToastPrimitives.Root.displayName;

// Defines the toast action component.
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "rounded-md inline-flex h-8 shrink-0 items-center justify-center border border-neutral-200 bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-neutral-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-neutral-50 group-[.destructive]:focus:ring-red-500 dark:border-neutral-800 dark:ring-offset-neutral-950 dark:hover:bg-neutral-800 dark:focus:ring-neutral-300 dark:group-[.destructive]:border-neutral-800/40 dark:group-[.destructive]:hover:border-red-900/30 dark:group-[.destructive]:hover:bg-red-900 dark:group-[.destructive]:hover:text-neutral-50 dark:group-[.destructive]:focus:ring-red-900",
      className,
    )}
    {...props}
  />
));
// Sets the display name for the toast action component.
ToastAction.displayName = ToastPrimitives.Action.displayName;

// Defines the toast close component.
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "rounded-md absolute right-2 top-2 p-1 text-neutral-950/50 opacity-0 transition-opacity hover:text-neutral-950 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 dark:text-neutral-50/50 dark:hover:text-neutral-50",
      className,
    )}
    toast-close=""
    {...props}
...
// Sets the display name for the toast close component.
ToastClose.displayName = ToastPrimitives.Close.displayName;

// Defines the toast title component.
...
// Sets the display name for the toast title component.
ToastTitle.displayName = ToastPrimitives.Title.displayName;

// Defines the toast description component.
...
// Sets the display name for the toast description component.
ToastDescription.displayName = ToastPrimitives.Description.displayName;

// Exports the toast provider.
type ToastProps = React.ComponentPropsWithoutRef<typeof Toast>;

// Exports the toast action element.
type ToastActionElement = React.ReactElement<typeof ToastAction>;

// Exports the toast components.
export {
  type ToastProps,
